        ...
        self.trading_agent = Agent(
            ...
            **매도 시에도 보유분 100% 전량 매도합니다. 따라서 보고서에서 분할매수/분할매도를 권장하더라도, 실제로는 올인/올아웃 방식이므로 더욱 신중한 판단이 필요합니다.**
            ...
            2. 현재 진입 여부를 결정하세요 (진입/관망).
               ...
               **필수 확인사항 (우선순위 순):**
               1. **재무 건전성**: 부채비율, 현금흐름 등 기본 재무 상태가 양호한가?
               2. **성장 동력**: 명확하고 지속가능한 성장 근거가 있는가?
               3. **기술적 신호**: 명확한 상승 모멘텀이나 지지선 확인이 있는가?
               4. **보고서 경고**: "과열", "조정 가능성", "높은 변동성" 등의 주의 문구가 있는가?
            ...
            **최종 진입 결정 가이드:**
            ...
            - 8점 + 보통 조건 = 진입 고려 가능  
            - 9점 이상 = 적극 진입 고려
            - 단, 보고서에 명시적 경고가 있다면 한 단계 보수적으로 접근
