...
- .env 안의 TELEGRAM_SIGNAL_CHANNEL_URL / TELEGRAM_FETCH_PAGES 같은 보조 fetch 설정도 컨테이너에 함께 전달됩니다.
...
# NOTE: The env-file is passed through to the container, including optional Telegram fetch settings.
SHELL=/bin/bash
PATH=$(generate_path)
