...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    "insights.performance.watched": "관망",
    "insights.performance.triggerType": "트리거 유형별 성과",
    "insights.performance.tradedVsWatched": "매매 vs 관망 비교",
    "insights.performance.rrAnalysis": "손익비 구간별 분석",
    "insights.performance.missedOpportunities": "놓친 기회",
    "insights.performance.missedOpportunitiesDesc": "관망했는데 30일 후 10% 이상 상승한 종목",
    "insights.performance.avoidedLosses": "회피한 손실",
    "insights.performance.avoidedLossesDesc": "관망해서 피한 30일 후 10% 이상 하락 종목",
  ...
  en: {
    ...
    "insights.performance.triggerType": "Performance by Trigger Type",
    "insights.performance.tradedVsWatched": "Traded vs Watched Comparison",
