...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    "trading.noData": "거래 내역이 없습니다",

    // Watchlist Page
    "watchlist.title": "관심 종목",
    "watchlist.description": "매수 보류 또는 관망 중인 종목",
    "watchlist.totalStocks": "총 종목",
    "watchlist.entry": "진입",
    "watchlist.watch": "관망",
    "watchlist.reason": "사유",
    "watchlist.analyzedDate": "분석일",
    "watchlist.buyScore": "매수 점수",
    "watchlist.noData": "관심 종목이 없습니다",
  ...
  en: {
    ...
    "trading.holdingDays": "Days Held",
    "trading.filters": "Filters",
    "trading.all": "All",
    "trading.profit": "Profit",
    "trading.loss": "Loss",
    "trading.scenario": "Scenario",
    "trading.noData": "No trading history",

    // Watchlist Page
    "watchlist.title": "Watchlist",
    "watchlist.description": "Stocks pending entry or under observation",
    ...
    "watchlist.noData": "No watchlist items",
